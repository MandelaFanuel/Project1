    ...
    <div class="container">
        <div class="container_principal_register">
            ...
            <form method="POST" class="user_form_register">
                ...
                <input type="submit" class="CNXvalidationbtn" name="validate"  value="Register" style="margin-bottom:3rem;">
