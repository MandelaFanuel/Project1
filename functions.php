...
if(isset($_POST["save"])){
    ...
    $query = "UPDATE gestion2 SET userfirstname ='$userfirstname', userlastname = '$userlastname',userpassword='$password_hash',idNum = '$id_num',adress = '$adress',birth_date='$birth_date',phone='$phone' WHERE id='$userID'";
    $result = mysqli_query($conn, $query);

    if($result){
        $success_message = "User edited successfully !.<br><a href='students.php' style='margin:0.2rem auto;background-color:blue;width:20%;letter-spacing:0.3rem;text-decoration:none; display:block;text-align:center;border-radius:30px;color:white;padding:0.2rem;font-family:'popins';'> Back</a>";
    }
