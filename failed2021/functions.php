...
//  SATISFIED FUNCTION 2021
function satisfaidBac1_2021(){
    global $conn;

    $query = "SELECT * FROM gestion2 WHERE premier_smstr < 70  OR second_smstr < 70 ";
    $result = mysqli_query($conn, $query);
    return $result;  
...
//  FAILED STUDENTS FUNCTION 2021
function failed_2021(){
    global $conn;

    $query = "SELECT * FROM gestion2 WHERE (promotion_date = '2021') AND (premier_smstr < 55  AND second_smstr < 55 )";
    $result = mysqli_query($conn, $query);
    return $result;  
   
}

//  FAILED STUDENTS FUNCTION 2022
function failed_2022(){
    global $conn;

    $query = "SELECT * FROM gestion2 WHERE (promotion_date = '2022') AND (premier_smstr < 55  AND second_smstr < 55 )";
    $result = mysqli_query($conn, $query);
    return $result;  
   
}

//  FAILED STUDENTS FUNCTION 2023
function failed_2023(){
    global $conn;

    $query = "SELECT * FROM gestion2 WHERE (promotion_date = '2023') AND (premier_smstr < 55  AND second_smstr < 55 )";
    $result = mysqli_query($conn, $query);
    return $result;  
...
//  FAILED STUDENTS FUNCTION 2023
function failed_2024(){
    global $conn;

    $query = "SELECT * FROM gestion2 WHERE (promotion_date = '2024') AND (premier_smstr < 55  AND second_smstr < 55 )";
    $result = mysqli_query($conn, $query);
    return $result;  
...
//  FAILED STUDENTS FUNCTION 2023
function failed_2025(){
    global $conn;

    $query = "SELECT * FROM gestion2 WHERE (promotion_date = '2025') AND (premier_smstr < 55  AND second_smstr < 55 )";
    $result = mysqli_query($conn, $query);
    return $result;  
